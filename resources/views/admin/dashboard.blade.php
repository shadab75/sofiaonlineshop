                ...
                <div class="card border-right-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">تعداد کاربران
                                </div>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                   <span class="bold">( {{$users->count()}} )</span>
                                </div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-right-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1"> تعداد سفارشات
                                </div>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-right-dark shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-dark text-uppercase mb-1"> تعداد کامنت ها
                                </div>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    <span class="bold">( {{$comments->count()}} )</span>
                                </div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-right-dark shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-dark text-uppercase mb-1"> تعداد محصولات
                                </div>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    <span class="bold">( {{$products->count()}} )</span>
                                </div>
                            </div>
                            <div class="col-auto">
