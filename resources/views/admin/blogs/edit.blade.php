    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            <div class="mb-4 text-center text-md-right ">
                <h5 class="font-weight-bold">ویرایش مقاله : {{ $blog->title }}</h5>
            </div>
            <hr>
            ...
            <form action="{{ route('admin.blogs.update' , ['blog' => $blog]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea id="keywords" rows="3" name="keywords" class="form-control">{{$blog->keywords}}</textarea>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="body">توضیحات</label>
                        <textarea class="form-control" rows="5" id="body" name="body">{{$blog->body}}</textarea>
                    </div>
