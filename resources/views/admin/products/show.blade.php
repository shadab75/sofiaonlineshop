        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" disabled>{{$product->keywords}}</textarea>
                </div>
...
{{--                                    </div>--}}
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img class="card-img-top"
                             src="{{ url(env('PRODUCT_IMAGES_UPLOAD_PAT') . $product->primary_image) }}"
                             alt="{{ $product->name }}">
                    </div>
                </div>
                ...
                @foreach ($images as $image)
                    <div class="col-md-3">
                        <div class="card">
                            <img class="card-img-top"
                                 src="{{ url(env('PRODUCT_IMAGES_UPLOAD_PAT') . $image->image) }}"
                                 alt="{{ $product->name }}">
                        </div>
                    </div>
                @endforeach
