        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <form action="{{ route('admin.banners.update' , ['banner' => $banner]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center mb-3">
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top" src="{{ url( env('BANNER_IMAGES_UPLOAD_PAT').$banner->image ) }}" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="alt">نامک</label>
                        <input class="form-control" id="alt" name="alt" type="text" value="{{$banner->alt}}" >
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" name="text">{{$banner->text}}</textarea>
                    </div>
